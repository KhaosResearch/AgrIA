...
def test_send_user_input_scenarios(
    ...
    # --- ARRANGE --- #
    # Prepare mockups
    monkeypatch.setattr(chat, "generate_user_response",
                        lambda x: expected_response)
...
def test_send_image_scenarios(
    ...
    # --- ARRANGE --- #
    # Prepare mockups
    monkeypatch.setattr(chat, "get_image_description",
                        lambda x, y: expected_response)
...
def test_send_parcel_info_to_chat_scenarios(
    ...
    # --- ARRANGE --- #
    monkeypatch.setattr(chat, "get_parcel_description",
                        lambda *args: expected_response)
...
def test_get_input_suggestion_scenarios(
    ...
    monkeypatch.setattr(chat, "get_suggestion_for_chat",
                        mock_get_suggestion_for_chat)
...
def test_load_active_chat_history_scenarios(
    ...
    def mock_get_role_and_content(user_input):
        return expected_response
    monkeypatch.setattr(chat, "get_role_and_content",
                        mock_get_role_and_content)
