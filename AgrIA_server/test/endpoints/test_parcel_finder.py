...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            lambda *args: (_ for _ in ()).throw(ValueError("The cadastral reference must have a length of 20 characters")),
...
def test_find_parcel_scenarios(
    ...
    if patch_cadastral_check:
        monkeypatch.setattr(parcel_finder, "check_cadastral_data", patch_cadastral_check)
