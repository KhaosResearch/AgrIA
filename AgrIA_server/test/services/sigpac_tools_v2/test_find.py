...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            MOCK_CADASTRAL_REF,
            MOCK_REG,
            (MOCK_GEOMETRY, MOCK_METADATA), # MOCK_GEOMETRY and MOCK_METADATA from conftest
            None,
            MOCK_GEOMETRY,
            MOCK_METADATA,
            id="Success_Found"
...
def test_find_from_cadastral_registry_scenarios(
    ...
    if expected_exception:
        ...
        # Expected Success
        geometry, metadata = sigpac_find.find_from_cadastral_registry(cadastral_ref_input)
