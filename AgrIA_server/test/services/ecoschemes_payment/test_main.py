...
def test_main_calculation_output(sample_input_data_str, mocker):
    ...
    ecoschemes_total_payments = [('P1', 192.81, 192.81), ('P3/P4', 3224.27, 3792.96),
                                 ('P5 (B)', 59.48, 59.48), ('P6/P7', 560.83, 797.99), ('N/A', 'N/A', 'N/A')]
    ...
    for ecoscheme_id, total_base_payment, total_pluri_payment in ecoschemes_total_payments:
        ...
        payment = [p for p in output['Estimated_Total_Payment']
                   if p['Ecoscheme_ID'] == ecoscheme_id][0]
