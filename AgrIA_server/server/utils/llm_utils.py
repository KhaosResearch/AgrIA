...
"""
    system_instructions = (
        role_prompt + classification_instruction + examples_instructions
    )
...
def load_prompt_from_json(
    json_path: str,
    prompt_type_key: str = "role",
    is_image_desc_prompt: bool = False,
    base_path: str = BASE_PROMPTS_PATH,
) -> dict:
    """
...
def load_documents_from_json(
    json_path: str, base_path: str = BASE_CONTEXT_PATH
) -> list:
    """
