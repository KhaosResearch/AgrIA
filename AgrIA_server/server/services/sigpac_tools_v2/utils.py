...
def read_cadastral_registry(cadastral_ref: str) -> dict:
    ...
    reg_sec = cadastral_ref[5]
    reg_pol = cadastral_ref[6:9]
    reg_par = cadastral_ref[9:14]
    reg_id = cadastral_ref[14:18]
    reg_control = cadastral_ref[18:]
    ...
    validate_cadastral_reference(cadastral_ref)
